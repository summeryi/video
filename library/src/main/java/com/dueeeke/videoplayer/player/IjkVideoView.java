...
public class IjkVideoView extends BaseIjkVideoView {
    ...
    public static final int SCREEN_SCALE_DEFAULT = 0;//默认，接近4-3
    public static final int SCREEN_SCALE_16_9 = 1;//长宽16-9
    public static final int SCREEN_SCALE_4_3 = 2;//长宽4-3
    public static final int SCREEN_SCALE_MATCH_PARENT = 3;//布满全屏
    public static final int SCREEN_SCALE_ORIGINAL = 4;//竖直左右有间距
